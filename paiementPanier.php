		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					...
					<form  action="traitement/PaiementPanier.php" method="post">
						<?php
					...
					<div class="mt-4">
						<div class="d-flex justify-content-center links">
							Vous Souhaitez annuler le paiement ? <a href="viewpanier.php" class="ml-2" style="color:grey">Retour sur le site</a>
						</div>	
